  ...
  return (
    <DrawerPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 flex h-full max-w-[calc(100vw-1rem)] flex-col gap-4 overflow-y-auto border-(--border-default) bg-paper p-6 shadow-(--shadow-3) transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:duration-300 data-[state=closed]:duration-200 dark:bg-(--bg-card-raised) dark:border-(--border-emphasis)",
