    ...
    try {
      ...
      const message =
        ...
        t("auth.forgotPasswordSuccess", {
          defaultValue: "If an account exists for this email, a verification code has been sent.",
        });
      ...
      setSubmitError(error?.message || t("auth.forgotPasswordError", {
  ...
  return (
    ...
    >
      <form className="flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <Button type="submit" variant="primary" size="lg" className="mt-2 w-full" isLoading={isSubmitting} loadingText={t("auth.sendingCode", { defaultValue: "Sending..." })}>
